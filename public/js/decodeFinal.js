...
(function() {
    ...
    setTimeout(() => {
        ...
        console.log('%c║   🔐 FINAL RIDDLE - READ CAREFULLY   ║', 'color: #00FFFF; font-weight: bold;');
        console.log('%c╚════════════════════════════════════════╝', 'color: #00FFFF; font-weight: bold;');
        console.log('');
        console.log('%cYou\'ve made it this far.', 'color: #00FF9C; font-size: 14px;');
        console.log('%cWhat\'s the color of success?', 'color: #00FF9C; font-size: 14px; font-weight: bold;');
        console.log('');
        console.log('%c💡 Hint: Look at the theme of this website...', 'color: #9D4EDD; font-size: 12px;');
        console.log('');
